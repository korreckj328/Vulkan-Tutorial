...
ApplicationLayersAndValidation::ApplicationLayersAndValidation() {}
...
bool ApplicationLayersAndValidation::checkValidationLayerSupport() {
...
std::vector<const char*> ApplicationLayersAndValidation::getRequiredExtensions(bool isValidationLayersEnabled) {
...
void ApplicationLayersAndValidation::setupDebugCallback(bool isValidationLayersEnabled, VkInstance vkInstance) {
...
void ApplicationLayersAndValidation::destroy(VkInstance instance, bool isValidationLayersEnabled) {
